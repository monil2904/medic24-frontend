    ...
    return (
        <div className="bg-red-50 border border-red-200 rounded-2xl p-4 mb-4 shadow-sm animate-in fade-in slide-in-from-top-4">
            ...
            <div className="mt-4 pt-3 border-t border-red-100">
                <a
                    href="tel:112"
                    className="flex items-center justify-center gap-2 w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-4 px-6 rounded-xl transition-colors shadow-sm text-lg"
                >
