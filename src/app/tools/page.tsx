    ...
    <>
      ...
      <div className="min-h-screen bg-white pt-16">
        <div className="max-w-4xl mx-auto px-5 py-12">
          ...
          {/* Tab Navigation */}
          <div className="flex overflow-x-auto gap-2 mb-8 pb-2 [&::-webkit-scrollbar]:hidden w-full">
            {(
              [
              ...
              <button
                ...
                className={`flex-shrink-0 px-4 py-2.5 rounded-xl font-semibold transition-colors text-sm ${
                  activeTab === tab.id
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        {useMetric ? (
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none text-slate-800 text-base"
            />
          </div>
        ) : (
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">Height (feet & inches)</label>
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">{useMetric ? "Weight (kg)" : "Weight (lbs)"}</label>
          <input
            type="number"
            inputMode="decimal"
      ...
      {bmi && bmiInfo && (
        <div className={`p-6 rounded-2xl text-center w-full shadow-sm ${bmiInfo.bgColor}`}>
          <div className="text-6xl font-black mb-2">
            <span className={bmiInfo.color}>{bmi}</span>
          </div>
          <div className={`text-xl font-bold ${bmiInfo.color} mb-3`}>
            {bmiInfo.category}
          </div>
...
function HeartRiskCalculator() {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none text-slate-800 text-base min-h-[44px]"
          />
        </div>
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none text-slate-800 bg-white text-base min-h-[44px]"
          >
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Systolic BP (mmHg)</label>
          <input
            type="number"
            inputMode="decimal"
            placeholder="e.g. 120"
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Total Cholesterol (mg/dL)</label>
          <input
            type="number"
            inputMode="decimal"
            placeholder="e.g. 200"
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-semibold text-slate-700 mb-2">HDL Cholesterol (mg/dL)</label>
          <input
            type="number"
            inputMode="decimal"
            placeholder="e.g. 50"
      ...
      {risk !== null && riskInfo && (
        <div className={`p-6 rounded-2xl text-center w-full shadow-sm ${riskInfo.bgColor}`}>
          <div className="text-6xl font-black mb-2">
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-semibold text-slate-700 mb-2">Waist Circumference (cm)</label>
          <input
            type="number"
            inputMode="decimal"
      ...
      <div className="mb-8">
        <label className="block mb-2 text-sm font-semibold text-slate-700">Physical Activity Level:</label>
        <select
          value={activity}
...
function CalorieCalculator() {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
      ...
      <div className="mb-8">
        <label className="block mb-2 text-sm font-semibold text-slate-700">Activity Level:</label>
        <select
          value={activity}
          onChange={(e) => setActivity(e.target.value)}
          className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none text-slate-800 bg-white text-base min-h-[44px]"
      ...
      {result && macros && (
        <div className="space-y-4">
          <div className="p-6 rounded-2xl bg-blue-50 border border-blue-200 text-center shadow-sm w-full">
            <div className="text-sm text-slate-500 mb-1 font-semibold">Daily Calorie Need</div>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
            <div className="p-4 rounded-xl bg-orange-50 border border-orange-200">
              <div className="text-xs sm:text-sm text-slate-500 font-semibold mb-1">Protein</div>
              <div className="text-2xl sm:text-3xl font-bold text-orange-600">
                {macros.protein}g
              </div>
              <div className="text-[10px] sm:text-xs text-slate-400 mt-1">30%</div>
            </div>
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200">
              <div className="text-xs sm:text-sm text-slate-500 font-semibold mb-1">Carbs</div>
              <div className="text-2xl sm:text-3xl font-bold text-blue-600">
                {macros.carbs}g
              </div>
              <div className="text-[10px] sm:text-xs text-slate-400 mt-1">45%</div>
            </div>
            <div className="p-4 rounded-xl bg-yellow-50 border border-yellow-200">
              <div className="text-xs sm:text-sm text-slate-500 font-semibold mb-1">Fats</div>
              <div className="text-2xl sm:text-3xl font-bold text-yellow-600">
                {macros.fats}g
              </div>
              <div className="text-[10px] sm:text-xs text-slate-400 mt-1">25%</div>
            </div>
          </div>
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 mb-8">
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Climate:</label>
          <select
            value={climate}
      ...
      {result && (
        <div className="space-y-4">
          <div className="p-6 rounded-2xl bg-blue-50 border border-blue-200 text-center shadow-sm w-full">
            <div className="text-sm text-slate-500 mb-1 font-semibold">Daily Water Intake</div>
            <div className="text-5xl sm:text-6xl font-black text-blue-600 mb-2">
              {result.liters}L
            </div>
